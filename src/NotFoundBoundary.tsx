...
export const NotFoundBoundary: React.FC<NotFoundBoundaryProps> =
  function ErrorBoundary(props: NotFoundBoundaryProps) {
    return (
...
> {
  static getDerivedStateFromProps(
    ...
    if (
      state.error &&
      props.context.steadyRoute!.url.pathname !== state.errorPathname
    ) {
      return {
        error: undefined,
  ...
  componentDidUpdate(
    prevProps: InnerNotFoundBoundaryProps,
    prevState: InnerNotFoundBoundaryState
  ) {
